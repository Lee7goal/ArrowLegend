...
export default class GameUI3 extends ui.test.TestSceneUI {
	...
	constructor(){
        ...
        var h = "http://10.92.22.145:8080/layaair-demo-master/h5/";
        //加载精灵
        Laya.Sprite3D.load(h+"res/threeDimen/skinModel/dude/dude.lh", Laya.Handler.create(this, function(dude:Laya.Sprite3D):void {
            scene.addChild(dude);
            this.dude = dude;
            
            //使用自定义材质
            var customMaterial1:CustomMaterial = new CustomMaterial();
            Laya.Texture2D.load(h+"res/threeDimen/skinModel/dude/Assets/dude/head.png", Laya.Handler.create(this, function(tex:Laya.Texture2D):void {
            ...
            Laya.Texture2D.load(h+"res/threeDimen/skinModel/dude/Assets/dude/jacket.png", Laya.Handler.create(this, function(tex:Laya.Texture2D):void {
            ...
            Laya.Texture2D.load(h+"res/threeDimen/skinModel/dude/Assets/dude/pants.png",Laya.Handler.create(this,function(tex:Laya.Texture2D):void{
            ...
            Laya.Texture2D.load(h+"res/threeDimen/skinModel/dude/Assets/dude/upBodyC.png",Laya.Handler.create(this,function(tex:Laya.Texture2D):void{
            ...
            //console.log((dude.getChildAt(0).getChildAt(0) as Laya.SkinnedMeshSprite3D).skinnedMeshRenderer.sharedMaterials);
            this.s1 = (dude.getChildAt(0).getChildAt(0) as Laya.SkinnedMeshSprite3D).skinnedMeshRenderer.sharedMaterials;
            this.s2 = baseMaterials;
        ...
        Laya.Texture2D.load("http://10.92.22.145:8080/layaair-demo-master/h5/res/threeDimen/texture/earth.png", Laya.Handler.create(null, function(tex:Laya.Texture2D):void{
        ...
        Laya.timer.frameLoop(1, this, function():void {
            if(this.i++<300)return;

            earth.transform.rotate(this.rotation_3d, true);
            if( Math.random() > 0.2){
                (this.dude.getChildAt(0).getChildAt(0) as Laya.SkinnedMeshSprite3D).skinnedMeshRenderer.sharedMaterials = this.s1;
            }else{
                (this.dude.getChildAt(0).getChildAt(0) as Laya.SkinnedMeshSprite3D).skinnedMeshRenderer.sharedMaterials = this.s2;
            }
        });
